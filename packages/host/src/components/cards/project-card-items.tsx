  ...
  return (
    ...
    >
      ...
      <div className="h-2/3">
        ...
        <div className="flex-between-start flex-col h-3/5">
          <p className="text-4xs md:text-3xs leading-snug text-left text-neutral-700">
            {projects.description
              ? `${projects.description.slice(0, 120)}...`
              : ''}
          </p>
