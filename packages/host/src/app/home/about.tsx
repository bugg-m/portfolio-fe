...
const About: React.FC = () => {
  return (
    <section className="section animate-appearBottomRight bg-primary-100 border-x border-b border-primary-500 md:rounded-rl-full rounded-rl-default">
      <div className="max-w-4xl mx-auto px-4">
        <h3 className="header">About Me</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-8 items-center justify-center">
          <div className="flex-center col-span-1">
            <Image
              src={images.profile}
              alt="Manish Kumar"
              className="w-48 h-auto hover-scale-110 hover:bg-secondary-50 animate-appearBottomLeft"
              shape="lg"
              rounded="md"
            />
          </div>
